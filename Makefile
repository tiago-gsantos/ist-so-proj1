...
ems: main.c constants.h operations.o parser.o eventlist.o filehandler.o sort.o
	$(CC) $(CFLAGS) $(SLEEP) -o ems main.c operations.o parser.o eventlist.o filehandler.o sort.o
...
clean:
	rm -f *.o ems ./jobs/*.out ./public-tests/*.out
